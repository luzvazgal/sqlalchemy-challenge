...
def tobs():
      ...
      #The most active station:
        ...
        max_temp_station.append({'station': station_id[0]})
        ...
        max_temp_station.append(dates_tobs_dic)
...
def temperature(start):
        ...
        try:
                ...
                return jsonify({"Error":"Incorrect date format, should be YYYY-MM-DD"})
      ...
      #The most active station:
        ...
        #Getting max, min, average temperatures given a start date
        station_temp_q = (
