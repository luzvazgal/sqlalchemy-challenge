...
1. Repository for this project is `https://github.com/luzvazgal/sqlalchemy-challenge`. 

2. Project has the following structure:
...
* Templates: including html file templates to format Flask Responses
